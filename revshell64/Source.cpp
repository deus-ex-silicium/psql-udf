...
- C/C++ => General = Additional Include Directories = $(SolutionDir)\include\psql12\include\server\port\win32_mscv;$(SolutionDir)\include\psql12\include\server\port\win32;$(SolutionDir)\include\psql12\include\server;%(AdditionalIncludeDirectories)
- C/C++ => Code Generation => Enable C++ Exceptions = No
- C/C++ => Advances => Compile As = C Code (/TC)
- Linker => General => Additional Library Directories = $(ProjectDir)\include\psql12\lib;%(AdditionalLibraryDirectories)
- Linker => Input => Additional Dependencies = postgres.lib;%(AdditionalDependencies)
